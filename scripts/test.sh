...
./target/debug/vibe_coding_tracker analysis --path examples/test_conversation_gemini.jsonl --output examples/analysis_result_gemini.json
./target/debug/vibe_coding_tracker analysis --path examples/test_conversation_copilot.jsonl --output examples/analysis_result_copilot.json
