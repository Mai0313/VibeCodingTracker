...
fn test_get_cache_dir() {
    use vibe_coding_tracker::utils::paths::get_cache_dir;
...
fn test_get_pricing_cache_path() {
    use vibe_coding_tracker::utils::paths::get_pricing_cache_path;
...
fn test_find_pricing_cache_for_date_nonexistent() {
    use vibe_coding_tracker::utils::paths::find_pricing_cache_for_date;
...
fn test_list_pricing_cache_files() {
    use vibe_coding_tracker::utils::paths::list_pricing_cache_files;
