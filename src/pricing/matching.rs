...
mod tests {
    use super::*;
    use crate::pricing::ThresholdTier;
    ...
    fn test_empty_model_name() {
        // Empty string matches via substring logic and picks up the first entry;
        // the test documents that behavior rather than asserting a specific model.
        clear_pricing_cache();
