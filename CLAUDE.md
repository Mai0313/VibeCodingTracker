...
| Hermes        | `~/.hermes/state.db` (SQLite `session_model_usage` table, read via `rusqlite`; `usage` only)                                                                 |
